...
const services = [
  { icon: Truck, title: 'Delivery across Ghana', body: 'Clear delivery costs and contact-led fulfilment.' },
  ...
  { icon: Headphones, title: 'Human support', body: 'Customer details remain attached to every fulfilment record.' },
];
