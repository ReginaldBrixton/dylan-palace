  ...
  return (
    <div id="success-screen" className="w-full flex flex-col px-6 py-12 items-center bg-[#F9F9F8] min-h-[70vh] animate-fade-in text-center selection:bg-black selection:text-white pb-32">
      ...
      <button
        ...
        onClick={() => navigate('/')}
        className="w-full max-w-md bg-[#111111] text-white py-4 font-semibold text-[13px] uppercase tracking-widest hover:bg-black transition-colors rounded-lg shadow-md cursor-pointer"
      >
